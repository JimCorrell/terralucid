-- Read-only seventeen-correction ranking publication verification.
...
select json_build_object(
 ...
 'prior_ranking_needs_revisit',not ingest.county_geometry_snapshot_is_current('7d750c5646a7e6368835db664092e4941e14908f35369a19d90863bacbddd492','fad71a48eab71fce398a8e51bd3fb4e9b7169e1d0e0f2a6ed91b1a18a5fad259'),
 'activation_audit_present',exists(select 1 from ingest.audit_result where sha256='5706404c305240e90e460184ff6d3f138b89c92f6a105e287e8dea7d1fe10463'),
 'activation_occurrences',(select count(*) from ingest.finding_occurrence where audit_sha256='5706404c305240e90e460184ff6d3f138b89c92f6a105e287e8dea7d1fe10463'),
 'new_features_effective_holds_cleared',(select count(*)=3 from effective where source_id='lupc-zoning' and object_id in (27257109,27321193,27303187) and effective_geometry_hold is null),
