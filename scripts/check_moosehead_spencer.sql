-- Read-only verification of the two-proposal investigation and unchanged corrections.
with f as (
...
select json_build_object(
 ...
 'investigation_audit_present',exists(select 1 from ingest.audit_result where sha256='959a971c95dc6e81a1179d26f345eba9dc2fe9b908c40107f43272b27ef5d49a'),
 'investigation_occurrences',(select count(*) from ingest.finding_occurrence where audit_sha256='959a971c95dc6e81a1179d26f345eba9dc2fe9b908c40107f43272b27ef5d49a'),
 'investigated_features_still_held',(select count(*)=2 from effective where source_id='lupc-zoning' and object_id in (27208875,27336229) and effective_geometry_hold is not null),
 ...
 'qualified_rows',(select count(*) from effective where qualified_for_parcel_screening),
