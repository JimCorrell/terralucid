...
select json_build_object(
 ...
 'investigation_audit_present',exists(select 1 from ingest.audit_result where sha256='33259813dfcc2b5fa814d0f49547df52c71e5bab9f3a5e3de1e60106efe86673'),
 'investigation_occurrences',(select count(*) from ingest.finding_occurrence where audit_sha256='33259813dfcc2b5fa814d0f49547df52c71e5bab9f3a5e3de1e60106efe86673'),
 'source_observations',(select count(*) from ingest.source_response where registry_sha256='c90f1fd867d34cdd97ec052d9ce4adb652a3dcacab685aa0661de16132134464'),
 'three_cases_still_held',(select count(*)=3 from effective where source_id='lupc-zoning' and object_id in (27233351,27314083,27316137) and effective_geometry_hold is not null),
 ...
 'wrong_source_rejected',not ingest.county_geometry_snapshot_is_current('bcd341fe5cd1d7afe0a2d79a1e58991c5e4c954f6f8f64add9592a8cfca89eed','wrong-audit'),
