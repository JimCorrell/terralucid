-- Read-only county readiness append and unchanged county state.
...
select json_build_object(
 ...
 'readiness_audit_present',exists(select 1 from ingest.audit_result where sha256='bccb31dd5d50ad971ccfbfd9b9071e769ad694334cdb02b468150b4fcb259fa1'),
 'readiness_observations',(select count(*) from ingest.source_response where registry_sha256='6830ed026e4d6ed4afec28bbf70d6bc7a204eb3372bee07095e738f73b7ac491'),
