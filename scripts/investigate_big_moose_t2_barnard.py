...
from refresh_fourteen_correction_ranking import ACTIVATIONS

BASE=ROOT/'research/big-moose-t2-barnard'
RANKING='research/fourteen-correction-ranking/report.json'
RANKING_SHA='3dd7c8ccf884b20e49fae2f0949b047cf7635cea978ea287053b5a6ab96ef10d'
IDS=[27257109,27321193,27303187]
...
def build():
    ...
    for p,h in ACTIVATIONS.items():
        ...
        for c in activation['corrections']:
            corrections.append(c);parent={'county-corrections':'piscataquis-zoning-holds','moosehead-spencer-acceptance':'moosehead-spencer','three-zoning-acceptance':'three-zoning-priorities','next-three-zoning-acceptance':'next-three-zoning-priorities','latest-three-zoning-acceptance':'latest-three-zoning-priorities'}[Path(p).parent.name]
