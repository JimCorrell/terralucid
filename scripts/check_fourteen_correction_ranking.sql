-- Read-only fourteen-correction ranking publication verification.
...
select json_build_object(
 ...
 'prior_ranking_needs_revisit',not ingest.county_geometry_snapshot_is_current('bcd341fe5cd1d7afe0a2d79a1e58991c5e4c954f6f8f64add9592a8cfca89eed','fad71a48eab71fce398a8e51bd3fb4e9b7169e1d0e0f2a6ed91b1a18a5fad259'),
 'activation_audit_present',exists(select 1 from ingest.audit_result where sha256='ee31ee42e3d668e8236cc2db4fd9e6ca2a3b3dbf6f7c015826ce40587498ec36'),
 'activation_occurrences',(select count(*) from ingest.finding_occurrence where audit_sha256='ee31ee42e3d668e8236cc2db4fd9e6ca2a3b3dbf6f7c015826ce40587498ec36'),
 'new_features_effective_holds_cleared',(select count(*)=3 from effective where source_id='lupc-zoning' and object_id in (27233351,27314083,27316137) and effective_geometry_hold is null),
