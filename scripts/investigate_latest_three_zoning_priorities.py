...
from refresh_eleven_correction_ranking import ACTIVATIONS

BASE=ROOT/'research/latest-three-zoning-priorities'
RANKING='research/eleven-correction-ranking/report.json'
RANKING_SHA='5510a6d2d39e371d8456d68201970f047b6e8893c8fca0dfffc8b21ddf1a6e27'
IDS=[27233351,27314083,27316137]
...
def build():
    ...
    for p,h in ACTIVATIONS.items():
        ...
        for c in activation['corrections']:
            corrections.append(c);parent={'county-corrections':'piscataquis-zoning-holds','moosehead-spencer-acceptance':'moosehead-spencer','three-zoning-acceptance':'three-zoning-priorities','next-three-zoning-acceptance':'next-three-zoning-priorities'}[Path(p).parent.name]
