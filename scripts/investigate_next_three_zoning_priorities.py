...
from refresh_eight_correction_ranking import ACTIVATIONS

BASE=ROOT/'research/next-three-zoning-priorities'
RANKING='research/eight-correction-ranking/report.json'
RANKING_SHA='6b8896283cc6637d5d2dc77c51fe1fe28f2600f64c76ef25649f05893ad418eb'
IDS=[27224591,27320676,27243652]
...
def build():
    ...
    for p,h in ACTIVATIONS.items():
        ...
        for c in activation['corrections']:
            corrections.append(c);parent={'county-corrections':'piscataquis-zoning-holds','moosehead-spencer-acceptance':'moosehead-spencer','three-zoning-acceptance':'three-zoning-priorities'}[Path(p).parent.name]
