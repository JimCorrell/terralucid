#!/usr/bin/env python3
"""Capture bounded public document evidence without changing or interpreting bytes."""
import argparse
...
def main():
    ...
    if any(not r['url'].startswith('https://') for r in probes):raise ValueError('Public HTTPS required')
    ...
    for probe in probes:
        ...
        try:
            ...
            if len(data)>25_000_000:raise ValueError('Document exceeds 25 MB evidence cap')
