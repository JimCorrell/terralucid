-- Read-only deployment checks for the independent proposal review; no accepted geometry.
with f as (
...
select json_build_object(
 ...
 'investigation_audit_present',exists(select 1 from ingest.audit_result where sha256='b7d02438499be17b55445bb5b2c5cd621cbe6f24182d238569524e0c9ab20cb7'),
 'investigation_occurrences',(select count(*) from ingest.finding_occurrence where audit_sha256='b7d02438499be17b55445bb5b2c5cd621cbe6f24182d238569524e0c9ab20cb7'),
