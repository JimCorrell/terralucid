-- Read-only eight-correction ranking publication verification.
...
select json_build_object(
 ...
 'prior_ranking_needs_revisit',not ingest.county_geometry_snapshot_is_current('6953a46ca94beb0c5fa74bac958926d015afb78c65ccfe28c35b08fc10f9d048','fad71a48eab71fce398a8e51bd3fb4e9b7169e1d0e0f2a6ed91b1a18a5fad259'),
 'activation_audit_present',exists(select 1 from ingest.audit_result where sha256='7e5ec1b5350fbb6d657551ef31d1739a34a4e3e22d0e5f312d7c5e8bd3e87c17'),
 'activation_occurrences',(select count(*) from ingest.finding_occurrence where audit_sha256='7e5ec1b5350fbb6d657551ef31d1739a34a4e3e22d0e5f312d7c5e8bd3e87c17'),
 'new_features_effective_holds_cleared',(select count(*)=3 from effective where source_id='lupc-zoning' and object_id in (27304757,27270812,27207268) and effective_geometry_hold is null),
