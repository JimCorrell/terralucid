-- Extend only the reviewed cohort; preserve all existing correction/history controls.
...
declare old ingest.county_geometry_correction%rowtype; f ingest.county_inventory_feature%rowtype;
 p jsonb; r jsonb; pc jsonb; rc jsonb; c jsonb; rings jsonb; feature_sha text; proposal_source_field text;
begin
