-- Add only the eleven reviewed PR46 versions; retain all earlier cohorts and controls.
...
begin
 ...
 and new.review_audit_sha256='eca57f7cce399a9f4de70d6096c4adf002f79d5528927983374e19d51c5d6a50' then
  ...
  audit_source_field:='source_audit_sha256';
  recommendation:='supported_for_exact_version_acceptance_after_validator_extension';
 elsif new.object_id in (27342226,27365331,27364426,27339379,27364538,27324664,27321394,27366878,27261431,27304932,27358396)
 and new.proposal_audit_sha256='7f8aa420e8ad488e1cb4752b781488ef1489783282ab782bff99d109992f0221'
 and new.review_audit_sha256='7f8aa420e8ad488e1cb4752b781488ef1489783282ab782bff99d109992f0221' then
  proposal_source_field:='source_feature_sha256';combined_review:=true;
  audit_source_field:='source_audit_sha256';
  recommendation:='supported_for_exact_version_acceptance_after_validator_extension';
