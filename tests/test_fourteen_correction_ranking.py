...
from refresh_fourteen_correction_ranking import BASE,ROOT,ACTIVATIONS,validate_dependencies

class FourteenRankingTests(prior.RankingTests):
    def test_live_cohort_dependencies(self):
        ...
        self.assertEqual(len(cs),14);self.assertEqual(len(d['held_object_ids']),148)
