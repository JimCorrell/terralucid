...
from refresh_twenty_eight_correction_ranking import BASE,ROOT,ACTIVATIONS,validate_dependencies

class TwentyEightRankingTests(prior.RankingTests):
    def test_live_cohort_dependencies(self):
        ...
        self.assertEqual(len(cs),28);self.assertEqual(len(d['held_object_ids']),134)
