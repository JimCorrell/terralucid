...
from investigate_big_moose_t2_barnard import compare_source,scenario_area,BASE,ROOT,IDS
...
class ThreePriorities(unittest.TestCase):
    ...
    def test_exact_three_fixed_candidates(self):
        ...
        for c in r['cases']:
            ...
            expected={27257109:['nested_shell_hole'],27321193:['two_touching_holes','two_touching_holes'],27303187:['nested_shell_hole']}
            self.assertEqual([x['type'] for x in c['details']['splits']],expected[c['object_id']])
