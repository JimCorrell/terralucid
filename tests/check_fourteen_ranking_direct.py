...
from refresh_fourteen_correction_ranking import BASE,ROOT
...
checks=[]
targets=[r['ranking'][0]['object_id']]+[x['object_id'] for x in sorted(r['ranking'],key=lambda x:-x['additional_reduction_since_eleven_corrections_m2'])[:2]]
